var languageContent = {
    greek: {
      languageBtn: "EL",
      mainTitle: "Άδεια οπλοκατοχής και οπλοφορείας",
      pageTitle: "Άδεια οπλοκατοχής και οπλοφορεία",
      infoTitle: "Πληροφορίες για την άδεια οπλοφορίας 2023",
      subTitle1: "Αυτό το ερωτηματολόγιο μπορεί να σας βοηθήσει να βρείτε αν δικαιούστε να λάβετε άδεια οπλοκατοχής και οπλοφορείας.",
    ...
    english: {
      languageBtn: "EN",
      mainTitle: "Firearm License",
      pageTitle: "Firearm License",
      infoTitle: "Information on the issue of Firearm License 2023",
      subTitle1: "This questionnaire can help you determine if you are eligible to receive a firearm license.",
